...
print("Compiling HTML document for all 386 pages...")
...
pdf_output_path = os.path.join(out_dir, "Sultans_of_Deccan_Persian_Thesis_Final.pdf")

print("Rendering final 386-page PDF document...")
...
while more:
    ...
    page_count += 1
    if page_count % 50 == 0:
        print(f"Rendered {page_count} PDF pages...")
